...
exports["default"] = exports.PaginationTotalWithAdapter = void 0;
...
var paginationTotalAdapter = function paginationTotalAdapter(WrappedComponent) {
  return /*#__PURE__*/function (_pageResolver) {
    ...
    var _super = _createSuper(PaginationTotalAdapter);
    ...
    _createClass(PaginationTotalAdapter, [{
      ...
      value: function render() {
        var _this$calculateFromTo = this.calculateFromTo(),
          _this$calculateFromTo2 = _slicedToArray(_this$calculateFromTo, 2),
          from = _this$calculateFromTo2[0],
          to = _this$calculateFromTo2[1];
...
var PaginationTotalWithAdapter = paginationTotalAdapter(_paginationTotal["default"]);
exports.PaginationTotalWithAdapter = PaginationTotalWithAdapter;
var _default = paginationTotalAdapter;
