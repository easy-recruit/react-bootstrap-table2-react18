...
var _excluded = ["className", "style", "attrs", "visibleColumnSize", "tabIndexCell"];
...
function _getPrototypeOf(o) { _getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return _getPrototypeOf(o); } /* eslint react/prop-types: 0 */ /* eslint react/no-array-index-key: 0 */
var SimpleRow = /*#__PURE__*/function (_shouldUpdater) {
  _inherits(SimpleRow, _shouldUpdater);
  var _super = _createSuper(SimpleRow);
  ...
  _createClass(SimpleRow, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement("tr", _extends({
        style: style,
        className: className
      }, trAttrs), /*#__PURE__*/_react["default"].createElement(_rowPureContent["default"], _extends({
