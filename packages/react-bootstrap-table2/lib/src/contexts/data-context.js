...
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); } /* eslint camelcase: 0 */
var _default = function _default() {
  ...
  var DataProvider = /*#__PURE__*/function (_Component) {
    ...
    function DataProvider() {
      ...
      _defineProperty(_assertThisInitialized(_this), "getData", function (filterProps, searchProps, sortProps, paginationProps) {
  ...
  _defineProperty(DataProvider, "propTypes", {
