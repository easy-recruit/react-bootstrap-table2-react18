...
var _reactLoadingOverlay = _interopRequireDefault(require("react-loading-overlay"));
...
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); } /* eslint no-return-assign: 0 */
var _default = function _default(options) {
  return function (loading) {
    var _class;
    return _class = /*#__PURE__*/function (_React$Component) {
      _inherits(TableLoadingOverlayWrapper, _React$Component);
      var _super = _createSuper(TableLoadingOverlayWrapper);
      ...
      _createClass(TableLoadingOverlayWrapper, [{
        ...
        value: function render() {
          var _this = this;
          return /*#__PURE__*/_react["default"].createElement(_reactLoadingOverlay["default"], _extends({
            ref: function ref(n) {
              return _this.overlay = n;
            }
          }, options, {
            active: loading
          }), this.props.children);
